...
// PlatformErrorCode is returned from the Bungie API when a general API error occurs.
// Defined at https://bungie-net.github.io/#/components/schemas/Exceptions.PlatformErrorCodes.
type PlatformErrorCode int32

const (
	None                                                   PlatformErrorCode = 0
	Success                                                                  = 1
	...
	Duplicate                                                                = 13
	UnknownSqlResult                                                         = 14
	ValidationError                                                          = 15 // Deprecated, please do not check for this value anywhere.
	...
	DestinyCharacterNotLoggedIn                                              = 1635 // Note: This is one of those holdovers from Destiny 1. We didn't change the enum because I am lazy, but in Destiny 2 this would read "DestinyCharacterNotInSocialSpace"
