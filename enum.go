...
const (
	SocketVisibility_Visible SocketVisibility = iota
...
const (
	...
	ActivityDifficulty_Easy
	ActivityDifficulty_Normal
	ActivityDifficulty_Challenging
	ActivityDifficulty_Hard
	ActivityDifficulty_Brave
	ActivityDifficulty_AlmostImpossible
	ActivityDifficulty_Impossible
)
